        ...
        methods: {
            async startProcess() {
                try {
                    ...
                    await axios.post('https://theemailfinder-d8ctecfsaab2a7fh.norwayeast-01.azurewebsites.net/trigger_webjobs/kse1881/start');
            ...
            async stopProcess() {
                try {
                    ...
                    await axios.post('https://theemailfinder-d8ctecfsaab2a7fh.norwayeast-01.azurewebsites.net/trigger_webjobs/kse1881/stop');
            ...
            startPolling() {
                this.pollInterval = setInterval(async () => {
                    try {
                        const response = await axios.get('https://theemailfinder-d8ctecfsaab2a7fh.norwayeast-01.azurewebsites.net/trigger_webjobs/kse1881/status');
